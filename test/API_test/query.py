...
# figure_out_prompt = '''
# You will be given the user's prompt	along with two dictionary mappings. Your job is to figure out, given the prompt, the relevant code.

# For example, 
# If the prompt asks for a player's details, you must output the player's code using the dictionary mapping.
	
# 	"player": <his/her code>

# If the prompt asks for a teams's details, you must output the team's code using the dictionary mapping.
