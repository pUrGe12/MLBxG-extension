...
results = model.predict(source=SOURCE_VIDEO_PATH, save=False)
...
for frame_idx, r in enumerate(results):
    ...
    if hasattr(r, 'orig_img'):
        ...
        frame_width = 1920  # replace with your video width
        frame_height = 1080  # replace with your video height
