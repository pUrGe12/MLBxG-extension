...
model_weights1 = load_tools.load_model(model_alias='bat_tracking')
...
results = model2.predict(source=SOURCE_VIDEO_PATH, save=True)


# Idea

"""
1. Find the catcher's position
2. Find the pitcher's position

A lil unreliable though
"""