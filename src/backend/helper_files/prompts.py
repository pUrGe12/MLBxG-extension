...
You will also be provided some additional information on the user and the user's statcast data.
...
If the top 5 players also vary significantly from the user's stat then let the user know and explain why accordingly!
''']
