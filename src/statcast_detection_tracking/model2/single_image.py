# Should probably start with a single image baseball detection and then use the stitching of frames idea
...
SOURCE_IMAGE_PATH = './input/baseball_img_3.png'
SOURCE_VIDEO_PATH = "./baseball.mp4"

load_tools = LoadTools()
model_weights = load_tools.load_model(model_alias='ball_trackingv4')
model = YOLO(model_weights)

results = model.predict(source=SOURCE_IMAGE_PATH, save=True)	 # saves in runs/detect/predict

# To display
Image(filename="runs/detect/predict/baseball_img_3.jpg", width=600)
